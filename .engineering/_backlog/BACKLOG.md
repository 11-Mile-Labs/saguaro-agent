# Saguaro Agent — Backlog Catalog

Pre-implementation catalog. Promote items to `.engineering/_active/<slug>/` when ready to build.

## Catalog

| Slug | Title | Priority | Status |
| --- | --- | --- | --- |
| dynamic-workflow-start-from-inline-spec | Support `workflow_start` from an inline workflow document | low | backlog |
